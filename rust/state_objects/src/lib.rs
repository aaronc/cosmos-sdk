...
//     type Out<'a> = <(P1, P2) as KeyCodec>::Out<'a>;
...
//     }
//
//     pub fn get<'a>(&self, ctx: &dyn ReadContext, key: K::In<'_>) -> Result<Ref<'a, V::Out<'a>>> {
//         todo!()
//     }
//
//     pub fn get_stale(&self, ctx: &dyn Context, key: K::In<'_>) -> cosmossdk_core::Result<V::Out<'_>> {
//         todo!()
//     }
//
...
//     pub fn get(&self, ctx: &dyn ReadContext) -> Result<T::Out<'_>> {
//         todo!()
//     }
//
